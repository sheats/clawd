...
*Peter's life operating system. North uses this to contextualize decisions, categorize content, and keep things aligned.*

**Last updated:** 2026-01-25  
**Review cadence:** Daily (tasks) → Weekly (progress) → Monthly (adjustments) → Quarterly (priorities)
...
2. High Cotton — Marketing that moves product
3. North system — Quiet the noise, focus, compound
...
### ReturnZap
- **Status:** ~$500K ARR, ~1000 customers, has partner
- **Goal:** *...*
- **Notes:** *...*
...
- **Current:** Open to CTO / VP Eng / Staff Eng roles
- **Strengths:** Hands-on full-stack + leadership + architecture
- **Story:** First dev at ClearCare, scaled 0→4,000 agencies

### Content Strategy
- **Platform:** LinkedIn (primary)
- **Blockers:** Decision paralysis, feels awkward, shame about past content
- **Reframe:** Posting is teaching, not bragging

### Goals
- *What does your professional brand look like in 1 year?*
...
### Philosophy
- *How do you think about money? What's it for?*
...
### Current Focus
- *What are you actively learning/building skill in?*

### Areas of Interest
- *Topics that pull your attention...*

### Learning Queue
- *Books, courses, people to learn from...*
...
*This document evolves. Fill it in as you go. North will help you refine it over time.*
